...
{
	internal class ApplyMailDBManager : AbstractDBManager
	{
		#region Internal Methods
		public string m_bpm;
		public string m_gas;
		public ApplyMailDBManager()
		{
		...
		{
			string sql = $@"INSERT INTO [{m_gas}].[dbo].[ApplyMail] 
							([ApplyTime]
							  ,[Name]
							  ,[Depart]
							  ,[Wid]
			...
			{
				InsertMailParameter.ApplyTime,
				InsertMailParameter.Name,
				InsertMailParameter.Depart,
				InsertMailParameter.Wid,
				InsertMailParameter.Memo,
				InsertMailParameter.ReceiveName,
				InsertMailParameter.Address,
				InsertMailParameter.Return,
				InsertMailParameter.Print,
				InsertMailParameter.Weight,
				InsertMailParameter.Fee,
				InsertMailParameter.Content
			};
		...
		//internal bool InsertDormApplicationsMaster( InsertDormApplicationsMaster InsertMailParameter )
		//{
		...
		//	List<object> SQLParameterList = new List<object>()
		//	{
		//		InsertMailParameter.EmpID,
		//		InsertMailParameter.ApplicationDate,
		//		InsertMailParameter.Dorm,
		//		InsertMailParameter.RoomNum,
		//		InsertMailParameter.ReservationTime,
		//		InsertMailParameter.Finished,
		//		InsertMailParameter.LeaveDate,
		//		InsertMailParameter.ApplicationType,
		//		InsertMailParameter.EmpRemarks,
		//		InsertMailParameter.EmpName,
		//		InsertMailParameter.RoomCompany,
		//		InsertMailParameter.Remarks
		//	};
		//	bool bResult = m_dbproxy.ChangeDataCMD( sql, SQLParameterList.ToArray() );
		//	return bResult;
		//}

...
{
	internal class DecodeServoFunction : AbstractUseDLL, IDecodePWFunction
	{
		#region Public Methods

		string IDecodePWFunction.Execute( AbstractDecodePWParameter parameter )
		{
			return secretDLL.DLLGenerateDecodeServoPW( (DecodeServoParameter)parameter );
		}
		...
		internal DecodeServoFunction( ISecretDLL secretDLL ) : base( secretDLL )
		{
